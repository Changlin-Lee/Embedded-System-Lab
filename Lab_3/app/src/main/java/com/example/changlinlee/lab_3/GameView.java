...
public class GameView extends SurfaceView {
    public float mDivision;
    public static String TAG_ON_TOUCH_X = "tagOnTouchX";
    public static String TAG_ON_TOUCH_Y = "tagOnTouchY";
    private Handler mHandler;

    private final static int LINE_TOP_H = 0;
    private final static int LINE_MIDDLE_H = 1;
    private final static int LINE_BOTTOM_H =2;
    private final static int LINE_LEFT_V = 3;
    private final static int LINE_MIDDLE_V =4;
    private final static int LINE_RIGHT_V = 5;
    private final static int LINE_LEFT_D = 6;
    private final static int LINE_RIGHT_D = 7;
